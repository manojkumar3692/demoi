...
SECRET_KEY = '$g*1lj329g0(p1-z%9wvr#n4*lg-$as=p7#@*_5fa(9y-2&uhk'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', 'django-envb.eba-txwymtjh.us-west-2.elasticbeanstalk.com']
...
XRAY_RECORDER = {
    ...
    'AWS_XRAY_TRACING_NAME': 'DokypaySelfDeploy',
